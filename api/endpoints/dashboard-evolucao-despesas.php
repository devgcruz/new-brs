...
/**
 * Endpoint de Dashboard - Evolução de Despesas
 * Substitui DashboardController@getDadosEvolucaoDespesas do Laravel
 */
...
try {
    // Dados para gráfico de linha - Evolução de Despesas (últimos 12 meses)
    ...
    logSimples('❌ Erro ao obter dados de evolução de despesas', ['erro' => $e->getMessage()]);
    respostaJson(false, null, 'Erro ao buscar dados de evolução de despesas', 500);
}
