...
switch ($method) {
    ...
    case 'PUT':
        ...
        try {
            ...
            respostaJson(true, $updatedData, 'Marca atualizada com sucesso');
    ...
    case 'DELETE':
        ...
        try {
            ...
            respostaJson(true, null, 'Marca excluída com sucesso');
        } catch (PDOException $e) {
            if ($e->getCode() == 23000) {
                 respostaJson(false, null, 'Erro: Esta marca está em uso e não pode ser excluída.', 409);
            }
            respostaJson(false, null, 'Erro de banco de dados: ' . $e->getMessage(), 500);
        } catch (Exception $e) {
